import { Controller, HttpException, Post, Request, UploadedFiles, UseGuards, UseInterceptors } from "@nestjs/common";
import { CloudinaryService } from "./cloudinary.service";
import { FileInterceptor, FilesInterceptor } from "@nestjs/platform-express";
import { ApiBearerAuth, ApiBody, ApiConsumes, ApiResponse, ApiTags } from "@nestjs/swagger";
import { permissionErrorResponse, tokenErrorResponse } from "../global/api-responses";
...
export class CloudinaryController {
    ...
    @ApiResponse({
        status: 200, description: "upload blog images successfully", schema: {
            ...
            ], 200, 'change avatar successfully')
        }
    })
    @ApiResponse({ status: 400, description: "Invalid file type", schema: { example: new responseError(400, "Invalid file type") } })
    ...
    async uploadBlogImage(
        ...
        const responses = await this.cloudinaryService.uploadBlogImages(blogImages);
